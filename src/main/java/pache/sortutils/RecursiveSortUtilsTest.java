...
public class RecursiveSortUtilsTest {
	...
	public void testMergeSort_Integer() {
		Collection<? extends Comparable<Integer>> mergeSort = RecursiveSortUtils
	...
	public void testMergeSort_String() {
		Collection<? extends Comparable<String>> mergeSort = RecursiveSortUtils.mergeSort(Arrays
